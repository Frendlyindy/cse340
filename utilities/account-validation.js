 ...
 .custom(async (client_email) => {
  ...
  /* **************************
    ...
    * ************************ */
    ...
    res. render ("../views/client/registration", {
    ...
    validate.checkUpdateData = async (req, res, next) => {
      ...
      if (!errors.isEmpty()) {
      let nav = await utilities.getNav()
      res. render ("../views/client/editClient", {
      errors, message: null, title: "Update Account", nav, client_firstname, client_lastname, client_email,
      })
      return
      }
      next ()
      ...
      validate.checkPasswordData = async (req, res, next) => {
        ...
        let nav = await utilities.getNav()
        res. render ("../views/client/editClient", {
        errors, message: null, title: "Update Account", nav, client_password
        })
        return
        }
        next ()
    ...
    validate.checkLoginData = async (req, res, next) => {
      ...
      errors, message: null, title: "Registration", nav, client_firstname, client_lastname, client_email, client_password
      })
      return
      }
      next ()
